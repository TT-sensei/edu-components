...
export class CountUpTimer {
  ...
  start() { if (this._running) return this; this._running = true; this._startedAt = Date.now() - this._elapsed * 1000; emit(this.eventTarget, EDU_EVENTS.TIMER_START, { elapsed: this._elapsed }); this._interval = setInterval(() => this._tick(), 100); this._tick(); return this; }
  ...
  reset() { clearInterval(this._interval); this._running = false; this._startedAt = null; this._elapsed = 0; this._notifyTick(); return this; }
